    ...
    <footer className="bg-text-900 text-gray-50">
      <div className="max-w-screen-2xl mx-auto section-padding">
        ...
        <div className="grid md:grid-cols-3 gap-6 md:gap-12 lg:gap-16 mb-12 md:mb-16">
          {/* Company Info */}
          <div>
            <h3 className="text-2xl font-display font-semibold mb-6">ByeCupim</h3>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <Mail size={20} className="text-gray-100/60 mt-1 flex-shrink-0" />
                <a
              ...
              <li className="flex items-start gap-3">
                <Phone size={20} className="text-gray-100/60 mt-1 flex-shrink-0" />
                <a
              ...
              <li className="flex items-start gap-3">
                <MapPin size={20} className="text-gray-100/60 mt-1 flex-shrink-0" />
                <address className="text-gray-100/70 not-italic">
                  São Paulo, SP
                </address>
              </li>
            </ul>
