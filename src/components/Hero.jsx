  ...
  return (
    <section className="relative min-h-[85vh] flex items-center overflow-hidden bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200">
        ...
        <div className="grid lg:grid-cols-12 gap-8 md:gap-12 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            <div className="inline-flex items-center gap-2 bg-green-600/5 px-3 md:px-4 py-2 rounded-full mb-4 md:mb-6 animate-fade-in">
              <Shield size={14} className="text-green-600 md:w-4 md:h-4" />
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3 md:gap-4">
                      <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-green-600/5 flex items-center justify-center group-hover:bg-green-600 group-hover:scale-110 transition-all duration-300">
                        <IconComponent size={20} className="text-green-600 group-hover:text-gray-50 transition-colors md:w-6 md:h-6" />
                      </div>
                      <div>
                        <p className="text-2xl md:text-3xl font-display font-bold text-green-600">{stat.value}</p>
                        <p className="text-xs md:text-sm text-text-900/60">{stat.label}</p>
                      </div>
                    </div>
                  </div>
                )
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce">
        <div className="w-6 h-10 border-2 border-text-900/20 rounded-full flex items-start justify-center p-2">
          <div className="w-1 h-2 bg-text-900/40 rounded-full"></div>
        </div>
      </div>
    </section>
  )
